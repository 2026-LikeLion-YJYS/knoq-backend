-- KNOQ local demo database reset and seed data.
-- WARNING: This script removes every row from the local KNOQ application tables.
-- Run only against the local Docker database named `knoq`.

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

TRUNCATE TABLE notification;
TRUNCATE TABLE consultation_request_product;
TRUNCATE TABLE consultation_request;
TRUNCATE TABLE needs_analysis;
TRUNCATE TABLE saved_product;
TRUNCATE TABLE recognition_candidate;
TRUNCATE TABLE recognition;
TRUNCATE TABLE session_lifestyle_tag;
...
(
    ...
    1690000,
    '/demo/products/prod_12/front.png',
...
(
    ...
    1290000,
    '/demo/products/prod_33/front.png',
...
(
    ...
    1290000,
    '/demo/products/prod_34/front.png',
...
(
    ...
    1850000,
    '/demo/products/prod_35/front.png',
...
(
    ...
    1290000,
    '/demo/products/prod_36/front.png',
...
(
    ...
    2290000,
    '/demo/products/prod_37/front.png',
...
(
    ...
    1050000,
    '/demo/products/prod_38/front.png',
...
(
    ...
    1650000,
    '/demo/products/prod_39/front.png',
...
(
    ...
    1550000,
    '/demo/products/prod_40/front.png',
...
('prod_12', 'L'),
('prod_12', '11 x 33 x 31 cm'),
('prod_33', '미니'),
('prod_33', '9 x 19 x 19 cm'),
('prod_34', 'S'),
('prod_34', '6 x 26 x 22 cm'),
('prod_35', 'L'),
('prod_35', '18 x 41 x 32 cm'),
('prod_36', 'S'),
('prod_36', '10 x 26 x 19 cm'),
('prod_37', '50.5 cm / 19.9 인치'),
('prod_37', '23 x 51 x 29 cm'),
('prod_38', 'S'),
('prod_38', '15 x 25 x 31 cm'),
('prod_39', 'S'),
('prod_39', '13 x 29 x 32 cm'),
('prod_40', 'S'),
('prod_40', '9 x 21 x 37 cm');
